...
2. Create Foreign Currency Account
   - (optional) After creating a new account for the foreign currency, either:
     ...
     ![Account Name and Notes](assets/multi-currency-account-name-and-note.jpg)
...
3. Create Rules
   ...
   **Rule 1:**
   ...
   ![Rule 1](assets/multi-currency-rule-1.jpg)
   ...
   - Actions
     ...
     ![Rule Action Template mode not available](assets/multi-currency-rule-action.jpg)
     ![Rule Action Normal Mode](assets/multi-currency-rule-action-normal-instructions.jpg)
     ![Rule Action Template Mode](assets/multi-currency-rule-action-template.jpg)
   ...
   **Rule 2:**
   ...
   ![Rule 2](assets/multi-currency-rule-2.jpg)
...
1. Create a transaction in the foreign currency account using the foreign currency amount.  (i.e. normal budget currency is USD but account is AUD, then enter the AUD amount in the Payment or Deposit column)
   ![Pre-Conversion Transaction](assets/multi-currency-usage-preconvert.jpg)
...
![Apply Exchange Rate to Transaction](assets/multi-currency-usage-convert.jpg)

3. Go back to the foreign currency account to verify that the transaction was converted.
   ![Post-Conversion Transaction](assets/multi-currency-usage-postconvert.jpg)
